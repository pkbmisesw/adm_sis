<?php
	...
	if($op == "tambah"){
        ...
        if($stmt){		
			echo "<script>alert('Berhasil Tambah'); document.location.href=('../view/d_pokjac/kel?p=$id_kec&s=$status&kec=$kecamatan')</script>";
		}else{
			echo "<script>alert('Gagal Tambah'); document.location.href=('../view/d_pokjac/kel?p=$id_kec&s=$status&kec=$kecamatan')</script>";
		}
		...
		$sql = "DELETE FROM d_pokjac WHERE id = :id";
		$stmt = $conn->prepare($sql);
		$stmt->bindParam(':id', $id);
		$stmt->execute();
		
		if($stmt){		
			echo "<script>alert('Berhasil Menghapus'); document.location.href=('../view/d_pokjac/kel?p=$id_kec&s=$status&kec=$kec')</script>";
		}else{
			echo "<script>alert('Gagal Menghapus'); document.location.href=('../view/d_pokjac/kel?p=$id_kec&s=$status&kec=$kec')</script>";
		}
