<?php
	...
	if($op == "tambah"){
		...
		$harga_untung = $_POST['harga_jual'] - $_POST['harga_beli'];
		$qty = $_POST['qty'];
		$gambar = $_POST['gambar'];
        
        try {
          $sql = "INSERT INTO m_product SET
			nama = :nama,
			des = :des,
			...
			$stmt->bindParam(':harga_untung', $harga_untung);
		...
		try {
		  ...
		  if($stmt){		
			  echo "<script>alert('Berhasil Tambah'); document.location.href=('../view/m_product/add.php')</script>";
		  }else{
			  echo "<script>alert('Gagal Tambah'); document.location.href=('../view/m_product/add.php')</script>";
		  }
		...
		if($stmt){		
			echo "<script>alert('Berhasil Menghapus'); document.location.href=('../view/m_product/add.php')</script>";
		}else{
			echo "<script>alert('Gagal Menghapus'); document.location.href=('../view/m_product/add.php')</script>";
		}
