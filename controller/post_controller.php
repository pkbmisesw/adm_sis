...
date_default_timezone_set("Asia/Makassar");
	...
	if($op == "tambah"){
        ...
        if($stmt){		
			echo "<script>alert('Berhasil Tambah'); document.location.href=('../view/m_post')</script>";
		}else{
			echo "<script>alert('Gagal Tambah'); document.location.href=('../view/m_post')</script>";
		}
	    ...
	    if ($_POST['gambar'] == ""){
            ...
            //   $stmt->bindValue(':tgl', $tgl, PDO::PARAM_STR);
            //   $stmt->bindValue(':sdes', $sdes, PDO::PARAM_STR);
    		...
    		$sql = "SELECT * FROM m_post WHERE id = $id";
    		$stmt = $conn->prepare($sql);
    		$stmt->execute();
    		$row = $stmt->fetch();
    		$gambar = $row['gambar'];
