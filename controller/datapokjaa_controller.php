<?php
	...
	if($op == "tambah"){
        ...
        if($stmt){		
// 			echo "<script>alert('Berhasil Tambah'); document.location.href=('../view/d_pokjaa')</script>";
			echo "<script>alert('Berhasil Tambah'); window.history.back();</script>";
		}else{
// 			echo "<script>alert('Gagal Tambah'); document.location.href=('../view/d_pokjaa')</script>";
		...
		$sql = "DELETE FROM data_pokjaa WHERE id = :id";
		$stmt = $conn->prepare($sql);
		$stmt->bindParam(':id', $id);
		$stmt->execute();
		
		if($stmt){		
// 			echo "<script>alert('Berhasil Menghapus'); document.location.href=('../view/d_pokjaa/')</script>";
			echo "<script>alert('Berhasil Hapus'); window.history.back();</script>";
		}else{
// 			echo "<script>alert('Gagal Menghapus'); document.location.href=('../view/d_pokjaa/')</script>";
