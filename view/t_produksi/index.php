                ...
                <td>
                  <div class="input-group">
                    ...
                    <select class="form-control select2" style="width: 100%;" name="id">
                      <?php
                      $sql = $conn->prepare("SELECT * FROM m_bahan ORDER BY id DESC");
                      $sql->execute();
                      while($data=$sql->fetch()) {
                      ?> 
                          <option value="<?php echo $data['id'];?>"><?php echo $data['nama'];?> - Stok : <?php echo $data['qty'];?></option>
                      <?php } ?>
                    </select>
          ...
          <table class="table table-sm va-m mw-42">
            <tbody>
              ...
              <tr rowspan="2">
               ...
               <h3 id="total_nilai">
               <?php
                        $sql = "SELECT SUM(qty) AS qty FROM t_produksi WHERE stat = 0";
        ...
        <div class="box-body table-responsive">
          <table class="table table-bordered table-striped" style="font-size:14px;" >
            ...
            <?php
                   ...
                   $sql = $conn->prepare("SELECT * FROM `t_produksi` WHERE stat='0' ORDER BY id DESC");
                   $sql->execute();
                   while($data=$sql->fetch()) {
                ?>
                <tr>
              ...
              <tr>
                ...
                <td>
                  <div class="input-group date">
                    ...
                    <input type="text" name="qty" class="form-control pull-right text-bold" value="" >
                  </div>
                </td>
              </tr>

              <input type="hidden" class="form-control pull-right text-bold" name="tukang_id" id="pelid" value="">
        ...
        <div class="box-body table-responsive">
          <table class="table table-sm va-m mw-42">
            ...
            <!-- <tr>
              ...
              <tr class="s2">
                ...
                <td>
                    <select class="form-control select2" style="width: 100%;" id="pelangganid" onchange="samapel()">
                      <?php
                      $sql = $conn->prepare("SELECT * FROM m_tukang");
                      $sql->execute();
                      while($data=$sql->fetch()) {
                      ?> 
              ...
              <tr>
                <td>
                <button type="submit" class="btn btn-success btn-block" >Proses Produksi</button>
          </form>
          <?php
          $sqlct = "SELECT * FROM m_produksi ORDER BY id DESC";
