...
<input type="hidden" class="form-control" name="id" value="<?php echo $row['id']; ?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" placeholder="Status" name="stat" value="<?php echo $row['stat']; ?>">
                      <small style="color:red;">* mengubah status menjadi 2 membuat halaman diarahkan ke halaman lain</small>
                    </div>
                  </div>
