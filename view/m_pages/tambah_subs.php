            ...
            <div class="col-xs-12">
              ...
              <div class="card radius-15">
                <div class="card-body">
                  ...
                  <form action="../../controller/<?php echo $dba;?>_controller.php?op=tambahsu" method="post"
                    enctype="multipart/form-data" class="form-horizontal">


                    <input type="hidden" placeholder="Sub Pages Id" name="spages_id" value="<?php echo $_GET['id'];?>">
                    ...
                    <div class="form-group">
                      <div class="col-sm-offset-2 col-sm-10">
                        <button type="submit" class="btn btn-danger mt-2">Tambah</button>
                      </div>
                    </div>
                  </form>
