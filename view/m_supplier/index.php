            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
                   ...
                   $sql = $conn->prepare("SELECT * FROM `m_supplier` ORDER BY id DESC");
                   $sql->execute();
                ...
                <tr>
                  ...
                  <button 
                    ...
                    <a class="btn btn-light" onclick="return confirm('are you want deleting data')" href="../../controller/supplier_controller.php?op=hapus&id=<?php echo $data['id']; ?>">❌</a>
                  </td>
                </tr>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form action="../../controller/supplier_controller.php?op=tambah" method="post"  enctype="multipart/form-data">
