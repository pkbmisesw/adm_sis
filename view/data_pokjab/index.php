      ...
      <div class="row">
        ...
        <!--      </button>-->
          ...
          <tr class="rapi">
            ...
            <th colspan="24">Pendidikan dan keterampilan</th>
            <th colspan="10">Pengembangan kehidupan koperasi</th>
            <th rowspan="4">Keterangan</th>
            <th rowspan="4">Aksi</th>
          </tr>
          <tr class="rapi">
            <th rowspan="2" colspan="2">Jumlah warga yang masih 3 buta</th>
          ...
          <tr class="rapi">
            ...
            <th scope="col">Jumlah Peserta</th>
                ...
                <?php
                   ...
                   $sql = $conn->prepare("SELECT * FROM `data_pokjab` WHERE id_kel = '".$_SESSION['id_kel']."'");
                   $sql->execute();
                ...
                <tr>
                  <td><?php echo $count; ?></td>
                    ...
                    <td><?php echo $data['j_wm_l'];?></td>
                    <td><?php echo $data['j_wm_p'];?></td>
                  ...
                  <td>
                   ...
                   <button 
                      ...
                      data-nama_ling="<?= $data['nama_ling']?>" 
                        data-j_wm_l="<?= $data['j_wm_l']?>"
                        data-j_wm_p="<?= $data['j_wm_p']?>"
                ...
                <tr>
                  <th>No</th>
                   <th>Nama Lingkungan</th>
                    <th>Jumlah Warga Buta - Laki</th>
                    <th>Jumlah Warga Buta - Perempuan</th>
                    <th>Jumlah Paket A Kelompok Belajar</th>
                    <th>Jumlah Paket A Warga Belajar</th>
                    <th>Jumlah Paket B Kelompok Belajar</th>
                    <th>Jumlah Paket B Warga Belajar</th>
        ...
        <div class="modal-content">
          ...
          <form id="form-edit-transaksi-masuk">
              ...
              <div class="modal-body">
                ...
                <div class="form-group">
                <label class="control-label" >Jumlah Warga Buta Laki : </label>         
                    <input type="text" class="form-control" id="j_wm_l_edit" name="j_wm_l" readonly/>
                </div>
                
                <div class="form-group">
                <label class="control-label" >Jumlah Warga Buta Perempuan : </label>         
                    <input type="text" class="form-control" id="j_wm_p_edit" name="j_wm_p" readonly/>
                </div>
...
<script type="text/javascript">
     $(document).ready(function(){
        ...
        $(document).on('click','.btn_update',function(){
            ...
            $("#j_wm_l_edit").val($(this).attr('data-j_wm_l'));
            $("#j_wm_p_edit").val($(this).attr('data-j_wm_p'));
