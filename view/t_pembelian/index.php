            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <div class="input-group ">
                    ...
                    <input type="number" class="form-control pull-right" id="harga" name="harga" value="0">
                  </div>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  ...
                  <a class="btn btn-success" href="../m_product/add.php">Tambah Baru</a>
                </td>
              </tr>
            </tbody>
          </table>
          ...
          <table class="table table-sm va-m mw-42">
            <tbody>
              ...
              <tr rowspan="2">
               ...
               <h4 id="total_nilai">
               <?php
                        $sql = "SELECT SUM(total) AS total FROM t_pembelian WHERE stat = 0";
        ...
        <div class="box-body table-responsive">
          <table class="table table-bordered table-striped" style="font-size:14px;" >
            ...
            <?php
                   ...
                   $sql = $conn->prepare("SELECT * FROM `t_pembelian` WHERE stat='0' ORDER BY id DESC");
                   $sql->execute();
                   while($data=$sql->fetch()) {
                ?>
                <tr>
        ...
        <div class="box-body table-responsive">
          <table class="table table-sm va-m mw-42">
            ...
            <tr>
              ...
              <input type="hidden" class="form-control pull-right text-bold" id="totaln" name="total" value="<?php echo $row['total']?>">
    ...
    <div class="col col-md-6">
      <div class="box box-widget">
        <div class="box-body table-responsive">
          ...
          <?php
          $sqlct = "SELECT * FROM m_pembelian ORDER BY id DESC";
