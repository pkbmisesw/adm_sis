    ...
    <section class="content">
      <div class="row">
        ...
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#tambah">
          ...
          <a class="btn btn-success" href="../m_product/add.php">Tambah Banyak</a>    
          <!-- /.box -->
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
                   ...
                   $sql = $conn->prepare("SELECT * FROM `m_product` ORDER BY IF(nama RLIKE '^[a-z]', 1, 2), nama");
                   $sql->execute();
                ...
                <tr>
                  ...
                  <?php
                  $stmt = $conn->prepare("SELECT * FROM m_kategori WHERE id = '".$data['kategori_id']."'");
                  $stmt->execute();
                  $row = $stmt->fetch();
                  ?>
                  ...
                  <td><?php 
                  $nilai_aset = $data['qty'] * $data['harga_beli'];
                  echo "Rp. ".number_format($nilai_aset, 0). ",-";
                  ?></td>
                  <td><?php echo "Rp. ".number_format($data['harga_jual'], 0). ",-";?></td>
                  <td><a href="<?php echo $data['gambar'];?>">🎁</a></td>
                  <td>
                  <button 
                      data-id="<?= $data['id'] ?>" 
                      data-nama="<?= $data['nama'] ?>" 
                ...
                ?>
                Total Aset = <?= "Rp. ".number_format($totals,0).",-" ?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
            <label class="col-form-label">Nama :</label>
            <input type="text" class="form-control" id="myInputa" name="nama" placeholder="<?php echo $ketnama. " ".$master. " ..."; ?>" />
          </div>
