            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
                   ...
                   $sql = $conn->prepare("SELECT * FROM `m_siswa` ORDER BY id DESC");
                   $sql->execute();
      ...
      <div class="modal-body">
          <form action="../../controller/<?php echo $dba;?>_controller.php?op=tambah" method="post"  enctype="multipart/form-data">
            ...
            <label class="control-label" >Kebutuhan Khusus : </label>       
                <input type="text" class="form-control" name="k_khusus" placeholder="Silahkan Mengisi Kebutuhan Khusus"/>
            </div>
