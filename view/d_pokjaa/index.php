            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <button data-id="<?= $data['id'] ?>" data-kecamatan="<?= $data['kecamatan']?>"
                      data-j_pkbn="<?= $data['j_pkbn']?>" data-j_pkdrt="<?= $data['j_pkdrt']?>"
                      data-pola="<?= $data['pola']?>" data-p_pkbn_sim="<?= $data['p_pkbn_sim']?>"
                      data-p_pkbn_anggota="<?= $data['p_pkbn_anggota']?>" data-p_pkdrt_sim="<?= $data['p_pkdrt_sim']?>"
                      data-p_pkdrt_anggota="<?= $data['p_pkdrt_anggota']?>" data-pola_kel="<?= $data['pola_kel']?>"
                      data-pola_anggota="<?= $data['pola_anggota']?>" data-lansia_kel="<?= $data['lansia_kel']?>"
                      data-lansia_anggota="<?= $data['lansia_anggota']?>" data-g_jum_ker="<?= $data['g_jum_ker']?>"
                      data-g_jum_ruk="<?= $data['g_jum_ruk']?>" data-g_jum_agama="<?= $data['g_jum_agama']?>"
                      data-g_jum_jimpit="<?= $data['g_jum_jimpit']?>" data-g_jum_arisan="<?= $data['g_jum_arisan']?>"
                      data-ket="<?= $data['ket']?>" data-status="<?= $data['status']?>" type="button"
                      class="btn btn-light btn_update" data-toggle="modal">✎</button>
                    -
                    [<?php echo $data['no_urut'];?>]
                  </td>
                  <td><a
                      href="kel?p=<?php echo $data['id'];?>&s=2&kec=<?php echo $data['kecamatan'];?>"><?php echo $data['kecamatan'];?></a>
                  </td>
      ...
      <div class="modal-body">
        <form action="../../controller/<?php echo $dba;?>_controller.php?op=tambah" method="post"
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="p_pkbn_sim"
              placeholder="Silahkan Mengisi Peng PKBN Simulasi" />
          </div>

          <div class="form-group">
            <label class="control-label">Peng PKBN Anggota : </label>
            <input type="text" class="form-control" name="p_pkbn_anggota"
              placeholder="Silahkan Mengisi Peng PKBN Anggota" />
          </div>

          <div class="form-group">
            <label class="control-label">Peng PKDRT Simulasi : </label>
            <input type="text" class="form-control" name="p_pkdrt_sim"
              placeholder="Silahkan Mengisi Peng PKDRT Simulasi" />
          </div>

          <div class="form-group">
            <label class="control-label">Peng PKDRT Anggota : </label>
            <input type="text" class="form-control" name="p_pkdrt_anggota"
              placeholder="Silahkan Mengisi Peng PKDRT Anggota" />
          </div>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="pola_anggota"
              placeholder="Silahkan Mengisi Pola Asuh Anggota" />
          </div>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="lansia_anggota"
              placeholder="Silahkan Mengisi Lansia Anggota" />
          </div>

          <div class="form-group">
            <label class="control-label">Gotong Royong Kel Bakti : </label>
            <input type="text" class="form-control" name="g_jum_ker"
              placeholder="Silahkan Mengisi Gotong Royong Kel Bakti" />
          </div>

          <div class="form-group">
            <label class="control-label">Gotong Royong Kel Rukun : </label>
            <input type="text" class="form-control" name="g_jum_ruk"
              placeholder="Silahkan Mengisi Gotong Royong Kel Rukun" />
          </div>

          <div class="form-group">
            <label class="control-label">Gotong Royong Kel Agama : </label>
            <input type="text" class="form-control" name="g_jum_agama"
              placeholder="Silahkan Mengisi Gotong Royong Kel Agama" />
          </div>

          <div class="form-group">
            <label class="control-label">Gotong Royong Kel Jimpitan : </label>
            <input type="text" class="form-control" name="g_jum_jimpit"
              placeholder="Silahkan Mengisi Gotong Royong Kel Jimpitan" />
          </div>

          <div class="form-group">
            <label class="control-label">Gotong Royong Kel Arisan : </label>
            <input type="text" class="form-control" name="g_jum_arisan"
              placeholder="Silahkan Mengisi Gotong Royong Kel Arisan" />
          </div>
