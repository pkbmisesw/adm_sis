          ...
          <div class="box">
            ...
            <tr class="rapi">
                ...
                <?php
                   ...
                   $sql = $conn->prepare("SELECT * FROM `d_pokjac` WHERE status = 1");
                   $sql->execute();
          ...
          <form id="form-edit-transaksi-masuk">
              ...
              <div class="modal-body">
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                <label class="control-label" >Pangan Makanan Pokok Beras : </label>         
                    <input type="text" class="form-control" id="p_mp_beras_edit" name="p_mp_beras" />
                </div>
                
                <div class="form-group">
                <label class="control-label" >Pangan Makanan Pokok Non Beras : </label>         
                    <input type="text" class="form-control" id="p_mp_nberas_edit" name="p_mp_nberas" />
                </div>
                
                <div class="form-group">
                <label class="control-label" >Pangan Pemanfaatan Peternakan : </label>         
                    <input type="text" class="form-control" id="p_pp_ternak_edit" name="p_pp_ternak" />
                </div>
                
                <div class="form-group">
                <label class="control-label" >Pangan Pemanfaatan Perikanan : </label>         
                    <input type="text" class="form-control" id="p_pp_ikan_edit" name="p_pp_ikan" />
                </div>
                
                <div class="form-group">
                <label class="control-label" >Pangan Pemanfaatan Warung Hidup : </label>         
                    <input type="text" class="form-control" id="p_pp_warung_edit" name="p_pp_warung" />
                </div>
                
                <div class="form-group">
                <label class="control-label" >Pangan Pemanfaatan Lumbung Hidup : </label>         
                    <input type="text" class="form-control" id="p_pp_lumbung_edit" name="p_pp_lumbung" />
                </div>
                
                <div class="form-group">
                <label class="control-label" >Pangan Pemanfaatan Toga : </label>         
                    <input type="text" class="form-control" id="p_pp_toga_edit" name="p_pp_toga" />
                </div>
                
                <div class="form-group">
                <label class="control-label" >Pangan Pemanfaatan Tanaman Keras : </label>         
                    <input type="text" class="form-control" id="p_pp_tkeras_edit" name="p_pp_tkeras" />
                </div>
                
                <div class="form-group">
                <label class="control-label" >Jumlah Industri Pangan : </label>         
                    <input type="text" class="form-control" id="ji_pangan_edit" name="ji_pangan" />
                </div>
                
                <div class="form-group">
                <label class="control-label" >Jumlah Industri Sandang : </label>         
                    <input type="text" class="form-control" id="ji_sandang_edit" name="ji_sandang" />
                </div>
                
                <div class="form-group">
                <label class="control-label" >Jumlah Industri Jasa : </label>         
                    <input type="text" class="form-control" id="ji_jasa_edit" name="ji_jasa" />
                </div>
                
                <div class="form-group">
                <label class="control-label" >Jumlah Rumah Sehat : </label>         
                    <input type="text" class="form-control" id="jr_sehat_edit" name="jr_sehat" />
                </div>
                
                <div class="form-group">
                <label class="control-label" >Jumlah Rumah Tidak Sehat : </label>         
                    <input type="text" class="form-control" id="jr_tsehat_edit" name="jr_tsehat" />
                </div>
