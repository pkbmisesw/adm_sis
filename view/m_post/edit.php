            ...
            <div class="col-xs-12">
              ...
              <div class="card radius-15">
                <div class="card-body">
                  ...
                  <?php
                $id = $_GET['id']; 
                $sql = "SELECT * FROM m_post WHERE id = $id ORDER BY id DESC";
                  ...
                  <form action="../../controller/<?php echo $dba;?>_controller.php?op=edit" method="post"
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        ...
                        Mobile - Data PKK<br>
                        <a>10. Catatan Data</a><br>
                        <a>11. Data Umum</a><br>
                        <a>12. Data Pokja 1</a><br>
                        <a>13. Data Pokja 2</a><br>
                        <a>14. Data Pokja 3</a><br>
                        <a>15. Data Pokja 4</a><br>

                        Mobile - Menu Tambahan<br>
                        <a>16. Menu Capaian</a><br>
                        <a>17. Menu Prestasi</a><br>
                        <a>18. Menu Struktur</a><br>
                    ...
                    <div class="form-group">
                      <div class="col-sm-offset-2 col-sm-10">
                        <button type="submit" name="upload" class="btn btn-danger">Update</button>
                      </div>
                    </div>
                  </form>
