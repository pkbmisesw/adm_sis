<?php
	...
	if (isset($_POST['id'])){
	    ...
	    $sql = "UPDATE data_umum SET 
	    nama_ling = '".$_POST['nama_ling']."',
        p_rw='".$_POST['j_rw']."',
        p_rt='".$_POST['j_rt']."',
        dasa='".$_POST['j_dasawisma']."',
        k_rumah='".$_POST['j_krt']."',
        kk='".$_POST['j_kk']."',
        j_laki='".$_POST['j_a_total_l']."',
        j_perempuan='".$_POST['j_a_total_p']."'
	    WHERE nama_ling = '".$_POST['nama_ling']."' AND id_kel = '".$_SESSION['id_kel']."'";
	    $conn->query($sql);
	    
	    $sql = "UPDATE data_pokjab SET 
	    nama_ling = '".$_POST['nama_ling']."',
        j_wm_l='".$_POST['j_a_blaki']."',
        j_wm_p='".$_POST['j_a_bcwe']."'
	    WHERE nama_ling = '".$_POST['nama_ling']."' AND id_kel = '".$_SESSION['id_kel']."'";
	    $conn->query($sql);
	    
	    
	    $sql = "UPDATE data_pokjac SET 
	    nama_ling = '".$_POST['nama_ling']."',
        p_mp_beras='".$_POST['mp_beras']."',
        p_mp_nberas='".$_POST['mp_nonberas']."',
        p_pp_ternak='".$_POST['kp_ternak']."',
        p_pp_ikan='".$_POST['kp_ikan']."',
        p_pp_warung='".$_POST['kp_warung']."',
        p_pp_lumbung='".$_POST['kp_lumbung']."',
        p_pp_toga='".$_POST['kp_toga']."',
        p_pp_tkeras='".$_POST['kp_tanaman']."',
        ji_pangan='".$_POST['i_pangan']."',
        ji_sandang='".$_POST['i_sandang']."',
        ji_jasa='".$_POST['i_jasa']."',
        jr_sehat='".$_POST['kr_sehat']."',
        jr_tsehat='".$_POST['kr_tdk_sehat']."'
	    WHERE nama_ling = '".$_POST['nama_ling']."' AND id_kel = '".$_SESSION['id_kel']."'";
	    $conn->query($sql);
	    
	    
	    $sql = "UPDATE data_pokjad SET 
	    nama_ling = '".$_POST['nama_ling']."',
        j_jamban='".$_POST['jr_jamban']."',
        j_spal='".$_POST['jr_spal']."',
        j_sampah='".$_POST['jr_tsampah']."',
        j_k_pdam='".$_POST['sak_pdam']."',
        j_k_sumur='".$_POST['sak_sumur']."',
        j_k_sungai='".$_POST['sak_sungai']."',
        j_k_lain='".$_POST['sak_dll']."',
        j_pus='".$_POST['j_a_pus']."',
        j_wus='".$_POST['j_a_wus']."',
        j_kk='".$_POST['jkk_tabung']."'
	    WHERE nama_ling = '".$_POST['nama_ling']."' AND id_kel = '".$_SESSION['id_kel']."'";
	    $conn->query($sql);
