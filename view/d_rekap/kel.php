          ...
          <tr class="rapi">
            ...
            <th scope="col">Jasa</th>
                ...
                <?php
                   ...
                   $sql = $conn->prepare("SELECT * FROM `d_rekap` WHERE id_kec = '" .$id_kec. "' AND status = '" .$stat. "'");
                   $sql->execute();
                ...
                <tr>
                  ...
                  <button 
                    ...
                    data-j_kel="<?= $data['j_kel']?>" 
                    data-j_ling="<?= $data['j_ling']?>"
                    data-j_rw="<?= $data['j_rw']?>"
                    data-j_rt="<?= $data['j_rt']?>"
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
         ...
         <div class="form-group">
            ...
            <input type="text" class="form-control" id="myInput" name="kecamatan" value="<?php echo $_GET['kec']?>" placeholder="Silahkan Masukan Kecamatan" readonly/>
            </div>
            
            <div class="form-group">
            <label class="control-label" >Kelurahan : </label>       
                <input type="text" class="form-control" name="j_kel" placeholder="Silahkan Mengisi Jumlah Kelurahan"/>
            </div>
            
            <div class="form-group">
            <label class="control-label" >Jumlah Lingkungan : </label>       
                <input type="text" class="form-control" name="j_ling" placeholder="Silahkan Mengisi Jumlah Lingkungan"/>
            </div>
              ...
              <div class="modal-body">
               ...
               <div class="form-group">
                <label class="control-label" >Kecamatan : </label>        
                    <input type="text" class="form-control" id="kecamatan_edit" name="kecamatan" readonly>
                </div>
                
                <div class="form-group">
                <label class="control-label" >Jumlah Kelurahan : </label>         
                    <input type="text" class="form-control" id="j_kel_edit" name="j_kel" />
                </div>
                
                <div class="form-group">
                <label class="control-label" >Jumlah Lingkungan : </label>         
                    <input type="text" class="form-control" id="j_ling_edit" name="j_ling" />
                </div>
     ...
     $(document).ready(function(){
        ...
        $(document).on('click','.btn_update',function(){
         ...
         $("#kecamatan_edit").val($(this).attr('data-kecamatan'));
            $("#j_kel_edit").val($(this).attr('data-j_kel'));
            $("#j_ling_edit").val($(this).attr('data-j_ling'));
