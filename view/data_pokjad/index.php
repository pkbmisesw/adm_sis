      ...
      <div class="row">
        ...
        <!--      </button>-->
          ...
          <div class="box">
            ...
            <tr class="rapi">
                <th rowspan="4">No</th>
                <th rowspan="4">Nama Lingkungan</th>
            ...
            <tr class="rapi">
                ...
                <?php
                   ...
                   $sql = $conn->prepare("SELECT * FROM `data_pokjad` WHERE id_kel = '".$_SESSION['id_kel']."'");
                   $sql->execute();
          ...
          <form id="form-edit-transaksi-masuk">
              ...
              <div class="modal-body">
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                <label class="control-label" >Jumlah Rumah Yang Memiliki Jamban : </label>         
                    <input type="text" class="form-control" id="j_jamban_edit" name="j_jamban" readonly/>
                </div>
                
                <div class="form-group">
                <label class="control-label" >Jumlah Rumah Yang Memiliki Spal : </label>         
                    <input type="text" class="form-control" id="j_spal_edit" name="j_spal" readonly/>
                </div>
                
                <div class="form-group">
                <label class="control-label" >Jumlah Rumah Yang Memiliki Tempat Pembuangan Sampah : </label>         
                    <input type="text" class="form-control" id="j_sampah_edit" name="j_sampah" readonly/>
                </div>
                ...
                <div class="form-group">
                <label class="control-label" >Jumlah KRT Yang Menggunakan Sumur : </label>         
                    <input type="text" class="form-control" id="j_k_pdam_edit" name="j_k_pdam" readonly/>
                </div>
                
                <div class="form-group">
                <label class="control-label" >Jumlah KRT Yang Menggunakan Sumur : </label>         
                    <input type="text" class="form-control" id="j_k_sumur_edit" name="j_k_sumur" readonly/>
                </div>
                
                <div class="form-group">
                <label class="control-label" >Jumlah KRT Yang Menggunakan Sungai : </label>         
                    <input type="text" class="form-control" id="j_k_sungai_edit" name="j_k_sungai" readonly/>
                </div>
                
                <div class="form-group">
                <label class="control-label" >Jumlah KRT Yang Menggunakan Lain Lain : </label>         
                    <input type="text" class="form-control" id="j_k_lain_edit" name="j_k_lain" readonly/>
                </div>
                
                <div class="form-group">
                <label class="control-label" >Jumlah Pus : </label>         
                    <input type="text" class="form-control" id="j_pus_edit" name="j_pus" readonly/>
                </div>
                
                <div class="form-group">
                <label class="control-label" >Jumlah Wus : </label>         
                    <input type="text" class="form-control" id="j_wus_edit" name="j_wus" readonly/>
                </div>
                ...
                <div class="form-group">
                <label class="control-label" >Jumlah KK Yang memiliki Tabungan : </label>         
                    <input type="text" class="form-control" id="j_kk_edit" name="j_kk" readonly/>
                </div>
     ...
     $(document).ready(function(){
        ...
        $(document).on('click','.btn_update',function(){
          ...
          $("#nama_ling_edit").val($(this).attr('data-nama_ling'));
            ...
            $("#j_wus_edit").val($(this).attr('data-j_wus'));
