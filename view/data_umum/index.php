              ...
              <table id="example1" class="table table-bordered table-striped">
                <thead class="rapi">
                  <tr class="rapi">
                    ...
                    <th colspan="3" class="rapi">Jumlah Kelompok</th>
                ...
                //   $sql = $conn->prepare("SELECT * FROM `d_umum` WHERE status IN (1,3) ORDER BY no_urut ASC");
                   $sql = $conn->prepare("SELECT * FROM `data_umum` WHERE id_kel = '".$_SESSION['id_kel']."'");
                   $sql->execute();
              ...
              <div class="modal-body">
                <div class="form-group">
    			  ...
    			  <div class="form-group">
                    ...
                    <div class="form-group">
                    <label class="control-label" >PKK RW : </label>         
                        <input type="text" class="form-control" id="p_rw_edit" name="p_rw" readonly/>
                    </div>
                    
                    <div class="form-group">
                    <label class="control-label" >PKK RT : </label>         
                        <input type="text" class="form-control" id="p_rt_edit" name="p_rt" readonly/>
                    </div>
                    
                    <div class="form-group">
                    <label class="control-label" >Dasa Wisma : </label>         
                        <input type="text" class="form-control" id="dasa_edit" name="dasa" readonly/>
                    </div>
                    
                    <div class="form-group">
                    <label class="control-label" >Kepala Rumah Tangga : </label>         
                        <input type="text" class="form-control" id="k_rumah_edit" name="k_rumah" readonly/>
                    </div>
                    
                    <div class="form-group">
                    <label class="control-label" >Kepala Keluarga : </label>         
                        <input type="text" class="form-control" id="kk_edit" name="kk" readonly/>
                    </div>
                    
                    <div class="form-group">
                    <label class="control-label" >Jumlah Laki : </label>         
                        <input type="text" class="form-control" id="j_laki_edit" name="j_laki" readonly/>
                    </div>
                    
                    <div class="form-group">
                    <label class="control-label" >Jumlah Perempuan : </label>         
                        <input type="text" class="form-control" id="j_perempuan_edit" name="j_perempuan" readonly/>
                    </div>
