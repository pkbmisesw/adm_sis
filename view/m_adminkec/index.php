            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
                   ...
                   $sql = $conn->prepare("SELECT * FROM `m_user` WHERE level_id = 5 AND status_jabatan = 1 ORDER BY id DESC");
                   $sql->execute();
                ...
                <tr>
                  ...
                  <td>
                      <?php
                        $sqla = "SELECT * FROM m_kecamatan WHERE id = '".$data['id_kec']."'";
