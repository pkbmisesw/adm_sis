                ...
                <th scope="col">Jumlah yang memiliki kartu berobat gratis</th>
                  ...
                  <tbody>
                      ...
                      <?php
                           ...
                           $sql = $conn->prepare("SELECT * FROM `d_pokjad` WHERE status = 1");
                           $sql->execute();
                    ...
                    <tr class="rapi">
                     ...
                     <td><a href="dpokja4_k?p=<?php echo $data['id'];?>&s=2&kec=<?php echo $data['kecamatan'];?>"><?php echo $data['kecamatan'];?></a></td>
