    ...
    <div class="row">
      ...
      <!--    </div>-->
          ...
          <h2 class="entry-title">
            <a href="#" style="color:black;">Data Umum</a>
          </h2>
              ...
              <table style="border:1px solid black;" class="table table-bordered">
                  ...
                  <tbody>
                      ...
                      <?php
                           ...
                           $sql = $conn->prepare("SELECT * FROM `d_umum` WHERE status = 1 ORDER BY no_urut ASC");
                           $sql->execute();
                    ...
                    <td><a href="dumum_k?p=<?php echo $data['id'];?>&s=2&kec=<?php echo $data['kecamatan'];?>"><?php echo $data['kecamatan'];?></a></td>
                ...
                ?>
                  ...
                  <tfoot>
                      <?php
                           $sql = $conn->prepare("SELECT * FROM `d_umum` WHERE status = 3");
                           $sql->execute();
                           while($data=$sql->fetch()) {
                            ?>
                      <tr>
