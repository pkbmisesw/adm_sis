...
<?php	
	...
	$sql = 'SELECT * FROM m_post WHERE nama LIKE :keyword OR sdes LIKE :keyword OR created_at LIKE :keyword ORDER BY id DESC ';
...
<table class='tbl-qa'>
  <thead>
	<tr>
	  <th class='table-header' width='20%'>Gambar</th>
	  <th class='table-header' width='20%'>Nama</th>
	  <th class='table-header' width='40%'>Sdes</th>
  ...
  <tbody id='table-body'>
	...
	?>
	  <tr class='table-row'>
	      <td><img src="images/<?php echo $row['gambar']; ?>" width="200px" height="100px"></td>
