             ...
             <div class="col-lg-4 col-md-6 mb-4">
                <div class="latest-post">
                  <div class="latest-post-media">
                    ...
                    <a href="post?p=<?php echo $data['id'];?>" class="latest-post-img">
                      <img loading="lazy" class="img-fluid" src="images/<?php echo $data['gambar'];?>" style="width: 100%; height: 200px">
                    </a>
                  </div>
                  <div class="post-body">
                    <h5 class="post-title">
                      <a href="post?p=<?php echo $data['id'];?>" class="d-inline-block">
                         <?php echo $data['nama'];?></a>
                    </h5>
                    <div class="latest-post-meta">
                      <span class="post-item-date">
                        <i class="fa fa-clock-o"></i> <small>Penulis : <?php echo $data['penulis'];?> - <?php echo $data['tgl'];?> - Dilihat : <?php echo $data['view'];?>x</small></span>
                    </div>
